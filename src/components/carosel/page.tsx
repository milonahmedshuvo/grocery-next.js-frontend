...
const ProductCarousel = () => {
  ...
  return (
    <div className="relative w-full mb-20 mt-14">
      ...
      <button
        onClick={scrollPrev}
        className="absolute left-0 top-48 z-10 p-2 m-2 text-gray-500 hover:text-white bg-gray-300 rounded-full hover:bg-blue-500"
      >
      ...
      <button
        onClick={scrollNext}
        className="absolute right-0 top-48 z-10 p-2 m-2 text-gray-500 hover:text-white bg-gray-300 rounded-full hover:bg-blue-500"
      >
