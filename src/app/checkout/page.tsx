   ...
   <div> 
    ...
    <div className="flex flex-col md:flex-row justify-between">
              ...
              {products?.map((product: TProduct) => (
                <tr key={product._id} className="bg-white border-b">
                  ...
                  <td onClick={() => dispatch(productDelete(product))}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 hover:text-red-600">
      ...
      <div className="w-1/3 bg-red-50 mt-4 p-6 ">
        <span className="text-sm ">By placing your order, you agree to our company Privacy policy and Conditions of use.</span>
        <p className="border-b-1 text-lg mt-3">Order Summary</p>
        ...
        <button className="bg-blue-400 text-white w-full rounded-lg py-1 mt-3 "> Proceed to checkout </button>
